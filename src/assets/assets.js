...
export const posters = [
  {
    posterId: 1,
    namePoster: "Guardians of the Galaxy",
    poster: "/src/assets/backgroundImage.png",
  ...
  {
    posterId: 2,
    namePoster: "Thanh Gươm Diệt Quỷ: Vô Hạn Thành",
    poster:
      "https://otakuusamagazine.com/wp-content/uploads/2025/03/demon-slayer-infinity-castle-date1-1024x573.jpg",
    genre: ["Anime", "Action", "Shounen", "Sci-Fi"],
    overview:
  ...
  {
    posterId: 3,
    namePoster: "One Punch Man",
    poster:
      "https://gamek.mediacdn.vn/zoom/600_315/133514250583805952/2021/11/12/edit-od3-16367059175851481265790.jpeg",
    genre: ["Anime", "Action", "Shounen", "Fantasy", "Comedy"],
    overview:
      "Câu chuyện diễn ra tại thành phố Z của Nhật Bản tại thời điểm thế giới đầy những quái vật bí ẩn với sức mạnh ghê gớm đã xuất hiện và gây ra biết bao nhiêu thảm họa. Nhưng cũng chính tại đây xuất hiện 1 siêu anh hùng đấm phát chết luôn, có thể dễ dàng đánh bại và tiêu diệt những con quái vật này. Cũng chính vì tài năng hiếm có này mà có rất nhiều nghi ngại về khả năng thực sự của vị siêu anh hùng, thậm chí anh không bao giờ nhận được bất kỳ lòng tin nào từ dân chúng. Siêu anh hùng mạnh nhất thế giới có thể giết bất cứ ai chỉ với một đòn. Nhưng không có gì có thể thách thức anh ta, nên anh ta phải vật lộn với sự buồn chán và trầm cảm.",
    showDateTime: 2025,
    runtime: 125,
  },
  {
    posterId: 4,
    namePoster: "Haikyu!!: Trận Chiến Bãi Phế Liệu",
    poster:
      "https://quinlan.it/upload/images/2024/05/Haikyu-The-Dumpster-Battle-2024-recensione-932x460.jpg",
    genre: ["Anime", "Drama", "Sport"],
    overview:
      "Khi đội Karasuno chạm trán trung học Nekoma trong vòng ba của giải vô địch quốc gia, Hinata đặt cược tất cả để đối mặt với đối thủ Kenma!",
    showDateTime: 2024,
    runtime: 85,
  },
  {
    posterId: 5,
    namePoster: "84 Mét Vuông",
    poster:
      "https://dnm.nflximg.net/api/v6/BvVbc2Wxr2w6QuoANoSpJKEIWjQ/AAAAQV1zy5h8uaja61xq_vDlCh_9G9hO088bEpnjyWWMdL53NItbwb8AWrkrWXNmrLGrrnU1JQlSBaSvLtkB-j5YgBfzrUwbmb-jwd8WPlxQU0FOMtddmDNzd9pj1s-xU_FmyABy2jzvyK4P8KPXunPyWHQAI-Q.jpg?r=be8",
    genre: ["Action", "Drama"],
    overview:

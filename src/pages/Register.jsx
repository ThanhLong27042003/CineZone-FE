...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex justify-center items-center bg-[url('src/assets/login-background.jpg')] bg-cover bg-center">
      {/* Khung đăng ký chính - Tăng max-w lên */}
      <div className="flex flex-col items-center bg-white bg-opacity-95 rounded-2xl p-8 shadow-2xl w-full max-w-4xl mx-4">
        {/* Phần tiêu đề */}
        <div className="flex justify-center items-center py-4 border-gray-200 w-full mb-4">
          <h1 className="text-3xl font-bold text-gray-800">Đăng ký</h1>
        </div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col">
                ...
                <input
                  ...
                  id="userNameInput"
                  name="userName"
                  placeholder="Nhập địa chỉ tên người dùng của bạn"
                  required
                  className="p-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200"
                />
              </div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col">
                ...
                <textarea
                  ...
                  required
                  rows="2"
                  className="p-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200 resize-none"
                />
              </div>
